...
export const HOSPITAL_ROUTES = {
    ...
    EDIT_HOSPITAL: (id) => `${API_BASE}/hospital/hospitals/${id}`,
    GET_ALL_DOCTORS: `${API_BASE}/hospital/getalldoctors`,
    DOCTORS_TOGGLE: (id) => `${API_BASE}/hospital/doctorsToggle/${id}`,
    PATIENTS_TOGGLE: (id) => `${API_BASE}/hospital/PatientsToggle/${id}`,
