...
export const adminContainer = () => {
    ...
    const adminService = new AdminService(adminRepository, tokenService);
    const doctorManagementService = new DoctorManagementService(adminRepository, tokenService, doctorRepository);
    const adminController = new AdminController(adminService);
    const doctorManagement = new DoctorManagementController(doctorManagementService);
    const patientService = new patientManagementService(adminRepository, userRepository);
    const patientManagement = new PatientManagementController(patientService);
    return {
        adminController,
        doctorManagement,
        adminService,
