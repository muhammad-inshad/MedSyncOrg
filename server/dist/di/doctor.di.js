...
export const doctorContainer = () => {
    ...
    const doctorService = new DoctorService(doctorRepository, tokenService, appointmentRepo, leaveRepo, doctorMapper, doctorLeaveMapper);
    const doctorAuthService = new DoctorAuthService(doctorRepository, tokenService, doctorMapper, hospitalRepo, hospitalMapper, departmentRepo, qualificationRepo, specializationRepo, departmentMapper, qualificationMapper, specializationMapper);
