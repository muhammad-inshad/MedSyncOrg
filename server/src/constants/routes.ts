...
export const ADMIN_ROUTES = {
    ...
    EDIT_HOSPITAL: (id: string) => `${API_BASE}/admin/hospitals/${id}`,
    GET_ALL_DOCTORS: `${API_BASE}/admin/getalldoctors`,
    DOCTORS_TOGGLE: (id: string) => `${API_BASE}/admin/doctorsToggle/${id}`,
    PATIENTS_TOGGLE: (id: string) => `${API_BASE}/admin/PatientsToggle/${id}`,
