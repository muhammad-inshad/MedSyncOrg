...
import { COMMON, PATIENTROUTES, SUPERADMINROUTES } from "@/constants/routes/routes";
...
const ROLE_CONFIG: Record<string, { title: string; redirect: string }> = {
  doctor: {
    title: "Doctor Login",
    redirect: COMMON.REVIEWPENDING,
  },
  patient: {
    title: "Patient Login",
    redirect: PATIENTROUTES.SELECTHOSPITAL,
  },
  admin: {
    title: "Admin Login",
    redirect: COMMON.REVIEWPENDING,
  ...
  Superadmin: {
    ...
    redirect: SUPERADMINROUTES.DASHBOARD,
  },
};
...
const LogIn = () => {
  ...
  const onSubmit = async (data: LogInFormData) => {
    ...
    try {
      const response = await api.post(`/${safeRole}/login`, {
        ...data,
        role,
      });
