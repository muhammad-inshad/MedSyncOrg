...
type HospitalDoctorEditFormData = z.infer<typeof doctorEditSchema>;
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.specialization && (
                      <p className="text-[10px] text-rose-500 font-bold px-1">{errors.specialization.message}</p>
                    )}
                  </div>
...
export default HospitalDoctorEditpage;