...
type HospitalAddDoctorpageFormData = z.infer<typeof doctorRegistrationSchema>;

const HospitalAddDoctorpage: React.FC = () => {
  ...
  const onSubmit = async (data: HospitalAddDoctorpageFormData) => {
    try {
      ...
      const response = await hospitalApi.addDoctor(formData);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    {...register('department')}
                    id="department"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none ${errors.department ? 'border-red-500' : 'border-gray-300'
                      }`}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    id="qualification"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none ${errors.qualification ? 'border-red-500' : 'border-gray-300'
                      }`}
                  >
                ...
                <div className="md:col-span-2">
                  ...
                  <select
                    ...
                    id="specialization"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none ${errors.specialization ? 'border-red-500' : 'border-gray-300'
                      }`}
                  >
...
export default HospitalAddDoctorpage;