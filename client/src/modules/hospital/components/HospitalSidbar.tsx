...
const HospitalSidbar = ({ isOpen, setIsOpen }: HospitalSidebarProps) => {
  const [activeMenu, setActiveMenu] = React.useState('');
  const navigate = useNavigate();
  const dispatch = useAppDispatch();

  const menuItems: MenuItem[] = [
    { icon: LayoutDashboard, label: 'Dashboard', path: HOSPITAL_ROUTES.HOSPITALDASHBOARD },
