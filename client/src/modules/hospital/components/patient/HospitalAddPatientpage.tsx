...
const HospitalAddPatientpage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await hospitalApi.addPatient(submitData);
      console.log(response.data)
      toast.success("Profile added successfully!");
      navigate(HOSPITAL_ROUTES.HOSPITALPATIENT);
    } catch (error) {
...
export default HospitalAddPatientpage;