...
import { useAppSelector, useAppDispatch } from '../../hooks/redex'; 
...
const PatientProfile: React.FC = () => {
  ...
  const { user, profileData, isAuthenticated } = useAppSelector((state) => state.auth);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-linear-to-br from-blue-500 to-blue-600 rounded-2xl shadow-xl p-8 text-white">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="w-28 h-28 rounded-xl overflow-hidden border-4 border-white shadow-lg">
                <img
                  src={patient.image || avathar} // ← fixed: no curly braces
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-blue-50 rounded-xl p-5 shadow-sm h-fit">
              ...
              <button
                onClick={() => navigate(PATIENTROUTES.DOCTORREGISTRACTIONFORM)}
      ...
      {/* Uncomment when you implement the modal */}
      {/* {openEdit && (
